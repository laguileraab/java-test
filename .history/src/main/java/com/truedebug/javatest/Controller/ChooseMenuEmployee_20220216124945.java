...
public class ChooseMenuEmployee {
    ...
    public ModelAndView listMenu(@PathVariable String email){
        ...
        model.addAttribute("option1", menu);
        model.addAttribute("option2", menu);
        model.addAttribute("option3", menu);
        model.addAttribute("option4", menu);
        model.addAttribute("option5", menu);        if(!isAutenticated){
