            ...
            if (person!= null && person.getName().equals("Nora")) {
                ...
                public String delMenu(Model model) throws IOException, SlackApiException{
                    ...
                    if (person!= null && person.getName().equals("Nora")) {
                        ...
                        if(menu.getOption2()!=null && menu.getOption1() != ""){
                            
                        }
                        if(menu.getOption3()!=null && menu.getOption1() != ""){
                            
                        }
                        if(menu.getOption4()!=null && menu.getOption1() != ""){
                            
                        }
                        if(menu.getOption5()!=null && menu.getOption1() != ""){
