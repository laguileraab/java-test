...
public class ControllerMVC {
    ...
    @RequestMapping(value = "/order/{email}/{option}", method = RequestMethod.POST)
    public String listMenu(@ModelAttribute String recomendations, @PathVariable int option, @PathVariable String email, Model model){
        //ModelAndView model = new ModelAndView();
        if(!isAutenticated){
            //model.setViewName("index.html");
            //return model;
