...
public class ChooseMenuEmployee {
    ...
    public String addMenu(Model model){
        ...
        model.addAttribute("option1", menu.getOption1());
        model.addAttribute("option2",  menu.getOption2());
        model.addAttribute("option3",  menu.getOption3());
        model.addAttribute("option4",  menu.getOption4());
        model.addAttribute("option5",  menu.getOption5());
