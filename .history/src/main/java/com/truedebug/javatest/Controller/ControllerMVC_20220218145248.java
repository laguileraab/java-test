...
public class ControllerMVC {
    ...
    @RequestMapping(value = "/order/{option}/{recomendations}")
    public String listMenu(@RequestParam(value="email",required=false) String recomendations, @PathVariable int option, Model model){
        //ModelAndView model = new ModelAndView();
        if(!isAutenticated){
            //model.setViewName("index.html");
            //return model;
