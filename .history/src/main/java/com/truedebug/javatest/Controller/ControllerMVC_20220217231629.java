...
public class ControllerMVC {
    ...
    public String gesMenu(Model model, @ModelAttribute Menu menu){
        ...
        public String gesMenu(Model model, @PathVariable @Nullable UUID uuid){
        ...
        public String delMenu(@ModelAttribute Menu menu, Model model,@PathVariable @Nullable UUID uuid){
