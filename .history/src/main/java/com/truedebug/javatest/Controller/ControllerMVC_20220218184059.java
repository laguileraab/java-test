            ...
            if (person!= null && person.getName().equals("Nora")) {
                ...
                public String delMenu(Model model) throws IOException, SlackApiException{
                    ...
                    if (person!= null && person.getName().equals("Nora")) {
                        ...
                        if(menu.getOption1()!=null && menu.getOption1() != ""){
                            options.add();
                        }
                        if(menu.getOption2()!=null && menu.getOption2() != ""){
                            
                        }
                        if(menu.getOption3()!=null && menu.getOption3() != ""){
                            
                        }
                        if(menu.getOption4()!=null && menu.getOption4() != ""){
                            
                        }
                        if(menu.getOption5()!=null && menu.getOption5() != ""){
